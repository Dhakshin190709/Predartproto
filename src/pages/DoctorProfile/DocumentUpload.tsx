...
const FileUpload = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-md shadow-md">
      ...
      <div>
        <select
          className="w-[50%] rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black 
  ...
  Remove
        ...
        <div className="flex justify-center mt-4">
          <button
            ...
            className="w-[20%] bg-gradient-to-b from-[#004A99] to-[#007BFF] hover:from-[#007BFF] hover:to-[#004A99] 
