...
const ConferenceRegistration = () => {
  ...
  const events = [
    {
      id: '1',
      eventTitle: 'Pediatric Health Event',
      description: 'A free health check-up event for children focusing on nutrition and vaccinations.',
      date: '2024-11-30',
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded shadow-md">
      <h1 className="text-2xl font-bold mb-6 text-gray-800">Conference Registration</h1>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          >
            <option value="">-- Select an Conference --</option>
            {events.map((event) => (
