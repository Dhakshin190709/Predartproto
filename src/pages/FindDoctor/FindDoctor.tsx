...
//   const handleSpecialistSelection = (name: string) => {
...
//   return (
//     <div
//       className="w-full h-[60vh] bg-cover bg-center bg-no-repeat flex items-center justify-center mt-70"
//       style={{
//         backgroundImage:
//           "url('https://img.freepik.com/free-photo/watercolor-pastel-background_23-2151891293.jpg?semt=ais_hybrid&w=740')",
//       }}
//     >
//       <div className="max-w-6xl w-full px-6 py-8">
//         {/* Heading */}
//         <h2 className="text-3xl font-bold text-black text-center mb-8 pt-4 mt-">
//           Find Doctors
//         </h2>
...
//               Why Choose PreCare Doctors?
//             </h3>
//             <ul className="list-disc list-inside text-base md:text-lg leading-relaxed space-y-2">
//               <li>Highly experienced and verified professionals</li>
//               <li>Trusted by thousands of patients across India</li>
//               <li>Easy appointment booking & quick response</li>
//               <li>Top-rated specialists across all fields</li>
//             </ul>
//           </div>
//         </div>
