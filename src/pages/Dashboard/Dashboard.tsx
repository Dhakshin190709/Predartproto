  ...
  return (
    <div className="p-4">
      <div className="flex items-center gap-2 mb-4">
        ...
        ease-out hover:ease-in px-4 py-2 rounded-md">Book Appointment</button>
      </div>
...
<input
  ...
  value={
    selectedAppointment?.appointmentDate
      ? selectedAppointment.appointmentDate.split("T")[0] // Extracts only "yyyy-MM-dd"
      : ""
  }
  onChange={(e) =>
...
<div className="mt-2 flex justify-between items-center">
  ...
  <div className="flex items-center gap-2 text-gray-600">
    {/* <FaMapMarkerAlt color="#dc3545" />
    <span>Chennai</span> */}
     <FaUserMd color="#17a2b8" />  {/* Doctor Icon */}
...
<div className="mt-2 flex justify-between items-center">
  <span
    ...
    title={getStatusInfo(appointment.statusID)} // Tooltip for full text
  >
