...
const Tenant: React.FC = () => {
 ...
 useEffect(() => {
  ...
  const handleEditClick = (medicine: any) => {
    setFormData({
      pharmacyMedicineID: medicine.pharmacyMedicineID || '', // important for PUT
      pharmacyID: medicine.pharmacyID || '',
      medicineID: medicine.medicineID || '',
      batchNumber: medicine.batchNumber || '',
      expiryDate: medicine.expiryDate ? medicine.expiryDate.slice(0, 10) : '', // format YYYY-MM-DD for input type=date
...
useEffect(() => {
 ...
 if (!formData.batchNumber.trim()) {
  ...
  // GST
  if (
    (formData.gst === '' || formData.gst === null) &&
    !touchedFields.gst
  ) {
        ...
        >
          ...
          >
            <div className="flex flex-wrap gap-4 mb-4">
                ...
                <>
                  <div className="flex flex-col mb-4 w-78">
                    <select
                      ...
                      onChange={(e) =>
                        handleChange('pharmacyID', e.target.value)
                      }
                  ...
                  <div className="flex flex-col mb-4 w-78">
                    <select
                      ...
                      onChange={(e) =>
                        handleChange('medicineID', e.target.value)
                      }
                      className="rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary"
                    >
              ...
              <div className="flex flex-col mb-4 w-68">
                <input
                  type="number"
                  step="0.01"
                  ...
                  className="rounded-lg border border-stroke bg-transparent py-4 pl-4 pr-4 text-black outline-none focus:border-primary"
                />
